...
<div>
	<a href="{{ site.baseurl }}{% link _page/Ccs.md %}">
		<img src="/wpoc/assets/images/LowResIcon/Ccs.png" height="100" style="display: inline-block; margin-left: 20px; margin-right: 20px; margin-bottom: 5px; margin-top:5px"/>
	</a>
